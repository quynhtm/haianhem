				...
				<div class="wrap-main-view">
					<div class="line-post">
						<div class="content-post-line">
							<h1 class="title-head text-left"><a title="<?php echo $cat_name ?>" href="<?php echo $base_url.'/'.$cat_name_alias?>"><?php echo $cat_name ?></a></h1>
							<?php 
								if(count($arrListCat)>0){
							?>
							<div class="list-link-cat">
								<ul>
									<?php foreach($arrListCat as $v){ ?>
									<li><a href="<?php echo $base_url.'/'.$v['title_alias']?>" title="<?php echo $v['title']?>"><?php echo $v['title']?></a></li>
									<?php } ?>
								</ul>
								<div class="click-more-view-cat"></div>
							</div>
							<?php } ?>
							<div class="row">
