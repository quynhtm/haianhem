	...
	<div class="page-content-box">
		 <form class="form-horizontal" name="txtForm" action="" method="post" enctype="multipart/form-data">
            ...
            ?>
             ...
             <?php if(isset($fields['id']) && $fields['id']['value']>0){?>
            <div class="full-item-line comment-order-wrap">
                <label class="txtComment">Báo cáo:</label>
                <div class="list-comment">
                    <ul>
                        <?php echo allComment($fields['id']['value']); ?>
                    </ul>
                </div>
