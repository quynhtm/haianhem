		...
		<div class="wrapper">
			<h5>
				<?php
					...
					?> / <a href="<?php echo $base_url ?>/admincp/module">Quản lý module</a>
				</h5>
			<span class="tools">
				<a href="<?php echo $base_url ?>/admincp/permission/add" title="Add" class="icon-add"></a>
...
<script>
	jQuery(document).ready(function(){
		DELETE_ITEM.init('admincp/permission');
	});
</script>
