...
class _Ads extends Ads{
	...
	function listInputForm(){
		...
		$arr_fields = array(
				...
				'pos'=>array('type'=>'option', 'label'=>'Vị trí', 'value'=>'1', 'require'=>'' ,'attr'=>'','list_option'=>array('1'=>t('Header'),'2'=>t('Middle'),'3'=>t('Slider left'), '4'=>t('Slider right'), '5'=>t('Slider middle'), '6'=>t('Left'),'7'=>t('Right'),'8'=>t('Bottom'))),
